...
training_set = train_datagen.flow_from_directory('D:/MinorProject22/Dataset/train',
                                                 target_size=(sz, sz),
                                                 batch_size=10,
                                                 color_mode='grayscale',
                                                 class_mode='categorical')

test_set = test_datagen.flow_from_directory('D:/MinorProject22/Dataset/test',
                                            target_size=(sz , sz),
                                            batch_size=10,
                                            color_mode='grayscale',
                                            class_mode='categorical')
...
classifier.save("model-aplhabets.h5")
print('Model Saved')
