...
if not os.path.exists("D:/MinorProject22/Dataset"):
    os.makedirs("D:/MinorProject22/Dataset")
if not os.path.exists("D:/MinorProject22/Dataset/train"):
    os.makedirs("D:/MinorProject22/Dataset/train")
if not os.path.exists("D:/MinorProject22/Dataset/test"):
    os.makedirs("D:/MinorProject22/Dataset/test")

for i in ascii_uppercase:
    if not os.path.exists("D:/MinorProject22/Dataset/train/"+i):
        os.makedirs("D:/MinorProject22/Dataset/train/"+i)
    if not os.path.exists("D:/MinorProject22/Dataset/test/"+i):
        os.makedirs("D:/MinorProject22/Dataset/test/"+i)

mode = 'test'
folder = 'D:/MinorProject22/Dataset/'+mode+'/'
...
while True:
    ...
    cv2.putText(frame, "Z: " + str(no_of_img['Z']), (10, 408), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 0), 1)
    # print(frame.shape)
